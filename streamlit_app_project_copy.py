...
def load_data():
    ...
    #Vaccination Sites
    vaccine_sites_url = 'https://drive.google.com/file/d/10Gfa31pOXMhtvx9r-T-3488lXwE2qZDf/view?usp=share_link'
    vaccine_sites_file_id=vaccine_sites_url.split('/')[-2]
    vcs_dwn_url='https://drive.google.com/uc?id=' + vaccine_sites_file_id
    vaccine_sites = pd.read_csv(vcs_dwn_url)

    #Vaccines Receives 
    vaccine_url = 'https://drive.google.com/file/d/1JJdD-nnZCHwCPKSCqTz8ezdudixLfybJ/view?usp=share_link'
    vaccine_file_id=vaccine_url.split('/')[-2]
    vc_dwn_url='https://drive.google.com/uc?id=' + vaccine_file_id
    vaccines = pd.read_csv(vc_dwn_url)
    ...
    #epi data
    epi_data_url = "https://drive.google.com/file/d/1hgZ6yvEf_ruTxL5jaIr-FSv1hid-ZUtq/view?usp=share_link"
    epi_data_file_id = epi_data_url.split('/')[-2]
    epi_data_dwn_url = 'https://drive.google.com/uc?id=' + epi_data_file_id
    epi_data = pd.read_csv(epi_data_dwn_url)
